...
class CTR {
    ...
    fun encryptCTR(inputFile: String, outputFile: String, key: SecretKey) {
    ...
    fun create(): MutableList<Long> {
        ...
        encryptCTR("file1.txt", "file1_enc.txt", aesKey) // encrypting the first file so JIT can create the necessary classes #justJavaThings
        ...
        inputFiles.forEachIndexed { index, inputFile ->
            ...
            val time = measureTimeMillis {
                encryptCTR(inputFile, outputFile, aesKey)
            }
            timeList.add(time)
        }
